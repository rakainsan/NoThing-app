      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 w-full max-w-sm p-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="relative">
                ...
                onChange={change}
                required
                className={`w-full border rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-gray-500 ${errors.password ? 'border-red-400' : 'border-gray-200'}`}
            ...
            <div className="relative">
                ...
                onChange={change}
                required
                className={`w-full border rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-gray-500 ${errors.password_confirmation ? 'border-red-400' : 'border-gray-200'}`}
